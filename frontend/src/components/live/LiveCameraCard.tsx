  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
        ...
        >
          <Camera size={12} style={{ color: "var(--navy)" }} strokeWidth={2.2} />
        </div>
        <div style={{ minWidth: 0 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "var(--navy)", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            {cam.name}
          </div>
          <div style={{ fontSize: 8.5, color: "var(--text-muted)", letterSpacing: "0.04em", textTransform: "uppercase", marginTop: 1, fontWeight: 600 }}>
            {cam.sector}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
        ...
        >
          <span
            style={{ width: 5, height: 5, borderRadius: "50%", background: "#1A6B3C", flexShrink: 0 }}
          />
          <span style={{ fontSize: 8, fontWeight: 800, color: "#1A6B3C", letterSpacing: "0.06em" }}>LIVE</span>
        </div>
        <span style={{ fontSize: 8.5, color: "var(--text-muted)", fontFamily: "var(--font-mono)", whiteSpace: "nowrap", fontWeight: 600 }}>
          {cam.timestamp}
        </span>
      </div>
    </div>
