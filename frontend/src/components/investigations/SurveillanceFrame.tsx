...
export default function SurveillanceFrame({ variant, camera, time, compact = false, snapshotUrl }: SurveillanceFrameProps) {
  const p = (variant && PALETTES[variant]) ? PALETTES[variant] : PALETTES.checkpoint;
